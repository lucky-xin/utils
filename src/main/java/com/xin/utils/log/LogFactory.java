...
public class LogFactory {
    ...
    private static Map<String, Logger> loggers = Maps.newConcurrentMap();
    ...
    private static Logger generateLogger(String loggerFileName, Level level) {
        ...
        try {
            Appender appender = new DailyRollingFileAppender(layout, "../logs/" + loggerFileName + ".log", "yyyy-MM-dd");
